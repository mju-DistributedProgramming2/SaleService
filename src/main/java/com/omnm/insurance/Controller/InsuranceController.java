...
import com.omnm.insurance.DTO.GetEmployeeRequest;
import com.omnm.insurance.DTO.GetEmployeeResponse;
import com.omnm.insurance.DTO.LoginEmployeeRequest;
import com.omnm.insurance.Entity.Employee;
import com.omnm.insurance.Service.EmployeeService;
...
public class InsuranceController {
    ...
    public GetEmployeeResponse getInsuranceList() throws RemoteException, EmptyListException, TimeDelayException {
        Employee employee = this.employeeService.getEmployee(String.valueOf(getEmployeeRequest.getId()), getEmployeeRequest.getDepartment());
        GetEmployeeResponse getEmployeeResponse = new GetEmployeeResponse(employee);
